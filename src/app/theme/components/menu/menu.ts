...
export const horizontalMenuItems = [ 
    ...
    new Menu (60, 'Contacto', '/contacto', null, null, false, 0),  
    new Menu (70, 'Quiénes somos', '/quienes-somos', null, null, false, 0),
    new Menu (500, 'Comparar', '/comparar', null, null, false, 0),
