...
export class PropertiesSearchComponent implements OnInit {
  ...
  public propertyStatus = [
    {name:"A Estrenar" , value:1},
    {name:"Excelente" , value:2},
    {name:"Muy Bueno" , value:3},
    {name:"Regular" , value:4},
    {name:"Para Reciclar" , value:5},
    {name:"Para Demoler" , value:6},
    {name:"Con Mejoras" , value:7},
  ]
  ...
  public buildFeaturesPrimary() {
    const arr = this.featurePrimary?.map(featurePrimary => {
      ...
      // const arr =  featurePrimary.features?.map(feature => {
      //   return this.fb.group({
      //     id: feature.id,
      //     name: feature.name,
